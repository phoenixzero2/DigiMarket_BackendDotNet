...
namespace DbRepository.Models
{
    public partial class digimarket_devContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySql("server=digimarketdb.cfzesomwscuj.eu-central-1.rds.amazonaws.com;port=3306;user=admin;password=qhZX3h070Z;database=digimarket_sprint_4", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.28-mysql"));
            }
        }
