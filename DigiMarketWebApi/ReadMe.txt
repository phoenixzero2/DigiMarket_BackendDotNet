...
********** local ***********
Scaffold-DbContext "server=127.0.0.1;port=3306;user=root;password=1234;database=digimarket_dev"  Pomelo.EntityFrameworkCore.MySql -OutputDir Models -context digimarket_devContext -Force 
